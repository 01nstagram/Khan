...
function criarPainel() {
  ...
  painel.innerHTML = `
    <h3 style="margin:0 0 10px 0;">
      ...
      <span style="color:#b84eff;"> DESTROYER BY 1NSTA</span>
    </h3>
    ...
    <button id="fecharPainel" style="margin-top:10px;background:red;color:white;border:none;padding:5px 10px;border-radius:5px;cursor:pointer;">Fechar</button>
  `;
